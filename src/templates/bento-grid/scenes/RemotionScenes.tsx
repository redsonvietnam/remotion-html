// ---------------------------------------------------------------------------
// Bento Grid Remotion Wrappers — Bridge Remotion hooks to data components
//
...
// file that should import useCurrentFrame/useVideoConfig for Bento scenes.
// ---------------------------------------------------------------------------

import React from "react";
import { useCurrentFrame, useVideoConfig } from "remotion";
import { HookSceneData } from "./HookScene";
import { BentoSceneData } from "./BentoScene";
...
export const BentoScene = withRemotion(BentoSceneData);
