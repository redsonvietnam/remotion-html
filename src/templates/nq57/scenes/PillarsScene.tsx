...
export const PillarsScene: React.FC<Props> = ({
  ...
  return (
    <AbsoluteFill style={{ alignItems: "center", justifyContent: "center", flexDirection: "column", padding: "0 5% 12%" }}>
      ...
      <div style={{ fontFamily: BV, fontWeight: 800, fontSize: 50, color: nq57.colors.ink, marginTop: 16 }}>{title}</div>
      <div style={{ fontFamily: BV, fontWeight: 500, fontSize: 26, color: nq57.colors.accent2, marginBottom: 6 }}>{subtitle}</div>
